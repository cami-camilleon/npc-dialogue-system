...
personalities = {
    "haphazard": ["adamant", "hasty", "impish", "naughty", "rash"], 
    "heroic": ["bold", "brave", "hardy"], 
    "nonchalant": ["lax", "mild", "relaxed", "serious"], 
    "shy": ["bashful", "lonely", "modest", "timid"], 
    "silly": ["jolly", "naive", "quirky", "sassy"], 
    "soft": ["calm", "careful", "docile", "gentle", "quiet"]
}
